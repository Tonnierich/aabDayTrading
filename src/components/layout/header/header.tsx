...
const InfoIcon = () => {
    ...
    const socialLinks = [
        ...
        {
            name: 'Email',
            url: 'mailto:emiisdtrader@gmail.com',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        {
            name: 'Website',
            url: 'https://learnwith.emiisd_trader.com',
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        {
            name: 'YouTube',
            url: 'https://youtube.com/@emiisd_trader', // update with your YouTube channel URL
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
