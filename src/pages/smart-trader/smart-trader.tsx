...
const SmartTrader = observer(() => {
  ...
  const [enableVirtualHooks, setEnableVirtualHooks] = useState<boolean>(false)
  ...
  const purchaseOnce = async () => {
    ...
    if (enableVirtualHooks) {
      trade_option.virtual_hooks = true
    }
          ...
          <div className="smart-trader__card">
            <div className="smart-trader__row smart-trader__row--two">
              ...
              <div className="smart-trader__field">
                ...
                <select id="st-tradeType" value={tradeType} onChange={(e) => setTradeType(e.target.value)}>
                  {TRADE_TYPES.map((t) => (
            ...
            <div className="smart-trader__targets">
              <div className="smart-trader__field">
                <label htmlFor="st-target-profit">
                  {localize("Target Profit")} ({account_currency})
                </label>
                <input
                  id="st-target-profit"
                  type="number"
              ...
              <div className="smart-trader__field">
                <label htmlFor="st-target-loss">
                  {localize("Target Loss")} ({account_currency})
                </label>
                <input
                  id="st-target-loss"
                  type="number"
            ...
            <div className="smart-trader__meta">
              ...
              <Text size="xs" color={totalProfitLoss >= 0 ? "profit-success" : "loss-danger"}>
                {localize("P/L:")} {totalProfitLoss.toFixed(2)} {account_currency}
              </Text>
            </div>
