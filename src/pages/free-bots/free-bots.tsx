...
import x2 from './bot-files/DayTrading VIP.xml';
import x3 from './bot-files/DayTrading expert 🚀📊.xml';
import x4 from './bot-files/DayTrading 1$ System 💰.xml';
import x5 from './bot-files/DayTrading Fusion-X 2025.xml';
import x6 from './bot-files/DayTrading Rise & Fall Auto Switch 🔄📈📉.xml';
import x7 from './bot-files/DayTrading Even_Odd Auto Switch 2025🔄.xml';
import x8 from './bot-files/DayTrading Fusion Analyzer🔍🔍📊📊.xml';
import x9 from './bot-files/DayTrading Encroach Trader 💵.xml';
import x10 from './bot-files/New DollarPrinterBot  2025 Version 💰💰💰.xml';
import x11 from './bot-files/Alpha Version 2025.xml';
import x12 from './bot-files/DayTrading Version Of Candle Mine🎯🎯.xml';
...
const FreeBots = observer(() => {
    ...
    const botXmlMap: Record<string, string> = {
        ...
        'DayTrading VIP.xml': x2,
        'DayTrading expert 🚀📊.xml': x3,
        'DayTrading 1$ System 💰.xml': x4,
        'DayTrading Fusion-X 2025.xml': x5,
        'DayTrading Rise & Fall Auto Switch 🔄📈📉.xml': x6,
        'DayTrading Even_Odd Auto Switch 2025🔄.xml': x7,
        'DayTrading Fusion Analyzer🔍🔍📊📊.xml': x8,
        'DayTrading Encroach Trader 💵.xml': x9,
        'New DollarPrinterBot  2025 Version 💰💰💰.xml': x10,
        'Alpha Version 2025.xml': x11,
        'DayTrading Version Of Candle Mine🎯🎯.xml': x12,
    };
    ...
    const bots = [
        ...
        {
            name: 'DayTrading VIP',
            description: 'DayTrading VIP',
            file: 'DayTrading VIP.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading expert 🚀📊',
            description: 'DayTrading expert 🚀📊',
            file: 'DayTrading expert 🚀📊.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading 1$ System 💰',
            description: 'DayTrading 1$ System 💰',
            file: 'DayTrading 1$ System 💰.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading Fusion-X 2025',
            description: 'DayTrading Fusion-X 2025',
            file: 'DayTrading Fusion-X 2025.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading Rise & Fall Auto Switch 🔄📈📉',
            description: 'DayTrading Rise & Fall Auto Switch 🔄📈📉',
            file: 'DayTrading Rise & Fall Auto Switch 🔄📈📉.xml',
            icon: '🤖',
        },
        {
            name: 'xDayTrading Even_Odd Auto Switch 2025🔄xx',
            description: 'DayTrading Even_Odd Auto Switch 2025🔄',
            file: 'DayTrading Even_Odd Auto Switch 2025🔄.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading Fusion Analyzer🔍🔍📊📊',
            description: 'DayTrading Fusion Analyzer🔍🔍📊📊',
            file: 'DayTrading Fusion Analyzer🔍🔍📊📊.xml',
            icon: '🤖',
        },
        {
            name: 'DayTrading Encroach Trader 💵',
            description: 'DayTrading Encroach Trader 💵',
            file: 'DayTrading Encroach Trader 💵.xml',
            icon: '🤖',
        },
        {
        ...
        {
            name: 'DayTrading Version Of Candle Mine🎯🎯',
            description: 'DayTrading Version Of Candle Mine🎯🎯',
            file: 'DayTrading Version Of Candle Mine🎯🎯.xml',
            icon: '🤖',
        },
    ];
